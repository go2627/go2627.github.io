<!-- 
  ...
  NOTA: Utiliza Tailwind CSS a través de CDN para el diseño moderno y minimalista.
  A pesar de ser un recurso externo, la carga es instantánea y el archivo
...
<head>
    ...
    <title>CORE RING – Vida en Marte</title>
    <!-- Carga de Tailwind CSS para estilos modernos y minimalistas -->
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Configuración de la fuente Inter y el fondo oscuro */
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;800&display=swap');
        body {
            font-family: 'Inter', sans-serif;
            background-color: #0d1117; /* Gris muy oscuro, casi negro */
        }
        /* Estilos específicos para la barra de navegación y el contenido */
        .tab-button {
            transition: all 0.2s;
            cursor: pointer;
        ...
        .tab-button:hover:not(.active) {
            background-color: #2c313a; /* Un gris sutil al pasar el ratón */
        }
        .tab-button.active {
            color: #fca311; /* Naranja/Ámbar de Marte */
...
<body class="bg-gray-900 text-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-4xl mx-auto w-full p-4 md:p-8">
        ...
        <div id="monitor" class="tab-content">
            <h2 class="text-3xl font-bold mb-6 text-center">Monitor del Módulo "Olympus"</h2>
            <div id="monitor-metrics" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Las métricas se inyectarán aquí por JS -->
            </div>
            <p id="monitor-update-time" class="text-center text-sm mt-8 text-gray-500">Última actualización: --</p>
        </div>

        <!-- 2. APRENDE - Artículos educativos -->
        <div id="aprende" class="tab-content hidden">
            <div id="aprende-list-view">
                ...
                <div id="articulos-container" class="space-y-4">
                    <!-- Artículos se inyectarán aquí por JS -->
                </div>
            </div>
        ...
        <div id="test" class="tab-content hidden">
            <h2 class="text-3xl font-bold mb-6 text-center">Test de Preparación Marciana</h2>
            ...
            <div id="quiz-area" class="hidden max-w-xl mx-auto bg-gray-800 p-6 rounded-xl shadow-2xl border border-gray-700">
                <div id="quiz-question-container" class="space-y-6">
                    ...
                    <div id="quiz-options-container" class="space-y-3">
                        <!-- Opciones se inyectarán aquí por JS -->
                    </div>
                </div>
        ...
        <!-- 4. CÁMARA - Vista estática de Marte -->
        <div id="camara" class="tab-content hidden">
            <h2 class="text-3xl font-bold mb-6 text-center">Cámara de Transmisión en Vivo (Superficie)</h2>
            <div class="bg-gray-800 p-2 rounded-xl shadow-2xl">
                <div class="relative w-full aspect-video overflow-hidden rounded-lg">
                    <!-- Placeholder de imagen de Marte (URL pública para simular la imagen) -->
                    <img src="https://placehold.co/800x450/b7410e/ffffff?text=MARTE+-+Transmisión+en+Vivo" 
            ...
            <p class="text-center text-gray-500 mt-4 text-sm">Transmisión nominal. Se requiere la limpieza programada del lente del módulo Rover.</p>
        </div>

    </main>
    
    <!-- Pie de Página (Para mantener la estética) -->
    <footer class="bg-gray-800 text-gray-500 text-center p-4 text-sm mt-8">
        CORE RING &copy; 2025 | Simulación de Colonia Marciana
    </footer>

    <!-- Script JavaScript para la lógica de la aplicación -->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const ARTICULOS_APRENDE = [
                {
                    id: 1,
                    titulo: "La Delgada Atmósfera Marciana",
                    icono: "💨",
                    contenido: "La atmósfera de Marte es extremadamente delgada, con una presión superficial de solo 6.1 milibares (menos del 1% de la Tierra). Está compuesta principalmente por dióxido de carbono (95%). Esto requiere trajes presurizados y hábitats cerrados. El CO₂ es útil para cultivar plantas mediante el proceso de Sabatier para generar oxígeno y agua."
                },
                {
                    id: 2,
                    titulo: "El Agua Hielo Bajo la Superficie",
                    icono: "💧",
                    contenido: "Aunque Marte es un desierto frío, grandes cantidades de agua existen en forma de hielo en los casquetes polares y justo debajo de la superficie en muchas latitudes. Este hielo se puede extraer y purificar, siendo vital para beber, para los sistemas de soporte vital y para producir combustible de cohete (hidrógeno y oxígeno) para el viaje de regreso."
                },
                {
                    id: 3,
                    titulo: "Generación de Energía Autónoma",
                    icono: "⚡",
                    contenido: "La energía en una colonia marciana se genera primariamente a través de paneles solares fotovoltaicos, ya que la luz solar es abundante aunque con menor intensidad que en la Tierra. Los reactores de fisión nuclear compactos son la alternativa de alta potencia para bases permanentes, proporcionando calor y energía continua, especialmente durante las tormentas de polvo que bloquean el sol."
                },
                {
                    id: 4,
                    titulo: "Cultivo de Alimentos Hidropónicos",
                    icono: "🥕",
                    contenido: "Debido a la baja gravedad y la falta de un suelo orgánico viable (el regolito es tóxico por percloratos), los alimentos se cultivan en hábitats cerrados usando sistemas hidropónicos o aeropónicos. Estos sistemas reciclan agua y nutrientes, permitiendo cultivar verduras de hoja verde y otros vegetales vitales para la dieta y el oxígeno de la tripulación."
                },
                {
                    id: 5,
                    titulo: "Protección Contra la Radiación",
                    icono: "🛡️",
                    contenido: "Marte carece de un campo magnético global fuerte y tiene una atmósfera muy delgada, lo que significa que la radiación espacial y solar impacta directamente en la superficie. Los hábitats deben construirse bajo tierra o cubrirse con una capa de regolito (suelo marciano) de varios metros de espesor para proporcionar el blindaje necesario para la salud a largo plazo de los colonos."
                },
                {
                    id: 6,
                    titulo: "Monitoreo de la Salud de la Tripulación",
                    icono: "❤️",
                    contenido: "El monitoreo constante de los signos vitales (BPM, presión, etc.) es crucial. La baja gravedad a largo plazo puede provocar pérdida de densidad ósea y muscular. Los colonos deben seguir un estricto régimen de ejercicios diarios y someterse a chequeos médicos automatizados para mitigar los efectos fisiológicos de la vida marciana."
                },
                {
                    id: 7,
                    titulo: "Comunicaciones de Larga Distancia",
                    icono: "🛰️",
                    contenido: "Debido a la distancia entre la Tierra y Marte, la comunicación no es instantánea. Hay un retraso variable que va de 3 a 22 minutos (solo ida). Esto significa que no es posible una conversación en tiempo real. Las operaciones deben ser diseñadas para ser lo más autónomas posible, y todas las comunicaciones son por paquetes de datos."
                },
                {
                    id: 8,
                    titulo: "El Futuro de la Terraformación",
                    icono: "🌍",
                    contenido: "La terraformación es un concepto a largo plazo que implica modificar el entorno de Marte para hacerlo más habitable para los humanos, posiblemente liberando gases de efecto invernadero para espesar la atmósfera y elevar la temperatura. Aunque es un objetivo aspiracional, las primeras colonias se centran en 'vivir bajo cúpulas' y utilizar recursos 'in situ'."
                }
            ];

            const PREGUNTAS_TEST = [
                {
                    pregunta: "¿Cuál es el principal componente de la atmósfera de Marte?",
                    opciones: ["Nitrógeno", "Oxígeno", "Dióxido de Carbono", "Argón"],
                    respuestaCorrecta: "Dióxido de Carbono"
                },
                {
                    pregunta: "¿Cuál es el fenómeno más grande conocido en el sistema solar, ubicado en Marte?",
                    opciones: ["El Cañón Valles Marineris", "El Monte Olimpo", "El Polo Sur", "La Planicie Elysium"],
                    respuestaCorrecta: "El Monte Olimpo"
                },
                {
                    pregunta: "¿Qué técnica se utiliza para cultivar alimentos en el hábitat marciano?",
                    opciones: ["Cultivo en Regolito Abierto", "Siembra Tradicional", "Hidroponía", "Jardinería Aérea"],
                    respuestaCorrecta: "Hidroponía"
                },
                {
                    pregunta: "¿Cuál es el rango de retraso de tiempo para una señal de radio unidireccional entre la Tierra y Marte?",
                    opciones: ["Menos de 1 segundo", "1 a 3 minutos", "3 a 22 minutos", "Más de 1 hora"],
                    respuestaCorrecta: "3 a 22 minutos"
                },
                {
                    pregunta: "¿Cómo se protegen los hábitats de la radiación en Marte?",
                    opciones: ["Generadores de campos magnéticos", "Escudos de aluminio ligero", "Capas gruesas de regolito (suelo)", "Vidrio templado y reforzado"],
                    respuestaCorrecta: "Capas gruesas de regolito (suelo)"
                },
                {
                    pregunta: "¿Qué elemento es fundamental extraer del hielo marciano para el viaje de regreso a la Tierra?",
                    opciones: ["Metano", "Sulfuro de Calcio", "Hidrógeno (para combustible)", "Cloro"],
                    respuestaCorrecta: "Hidrógeno (para combustible)"
                },
                {
                    pregunta: "¿Qué color se asocia a menudo con el cielo de Marte durante el día?",
                    opciones: ["Azul brillante", "Rojo intenso", "Rosa pálido", "Amarillo-marrón (Butterscotch)"],
                    respuestaCorrecta: "Amarillo-marrón (Butterscotch)"
                },
                {
                    pregunta: "¿Qué significa el acrónimo 'BPM' en el contexto de la tripulación en el Monitor?",
                    opciones: ["Bytes por Milla", "Bombas por Minuto", "Batas de Protección Marciana", "Latidos por Minuto"],
                    respuestaCorrecta: "Latidos por Minuto"
                },
                {
                    pregunta: "¿Cuál es el objetivo final y a muy largo plazo de la modificación del medio ambiente marciano?",
                    opciones: ["Desmilitarización", "Industrialización", "Terraformación", "Comercio Interplanetario"],
                    respuestaCorrecta: "Terraformación"
                },
                {
                    pregunta: "¿Qué tipo de energía se considera la mejor opción a largo plazo y alta potencia para una colonia permanente?",
                    opciones: ["Energía Eólica", "Energía Solar Fotovoltaica", "Reactores de Fisión Nuclear", "Energía Geotérmica"],
                    respuestaCorrecta: "Reactores de Fisión Nuclear"
                }
            ];
            ...
            // ===============================================
            // III. FUNCIONES DE UTILIDAD Y LÓGICA CENTRAL
            // ===============================================
            ...
            function switchTab(tabId) {
                ...
                // Lógica de inicialización específica de cada tab (si es necesario)
                if (tabId === 'aprende') {
                    renderAprendeList();
                }
            }
            
            // --- 2. Lógica del Monitor (Simulación) ---
            ...
            function simularDatosModulo() {
                ...
                const data = [
                    { label: "Temperatura Exterior", value: `${temp}°C`, color: tempColor, desc: "Rango óptimo: -65°C a -60°C" },
                    { label: "Presión del Hábitat", value: `${pressure} Pa`, color: pressureColor, desc: "Rango óptimo: > 620 Pa (6.2 mbar)" },
                    { label: "Velocidad del Viento", value: `${wind} km/h`, color: windColor, desc: "Rango óptimo: < 12 km/h" },
                    { label: "BPM de la Tripulación", value: `${bpm} lpm`, color: bpmColor, desc: "Rango óptimo: 65 a 85 lpm" },
                    { label: "Estado Espejos Solares", value: mirrorStatus, color: mirrorColor, desc: "Sistema de orientación de paneles." },
                    { label: "Nivel de Oxígeno", value: `${generarNumeroAleatorio(20.5, 21.5, 2)}%`, color: 'text-green-400', desc: "Nivel de O₂ en la atmósfera del hábitat." },
                ];
                ...
                selectors.monitorUpdateTime.textContent = `Última actualización: ${new Date().toLocaleTimeString('es-ES')}`;
            }

            // --- 3. Lógica de Aprende ---
            function renderAprendeList() {
                // Asegurar que la vista de lista esté visible y el detalle oculto
            ...
            function renderQuizQuestion() {
                ...
                // Mostrar feedback si ya se ha respondido (solo en modo revisión)
            ...
            function submitQuiz() {
                ...
                let message = '';
                if (score === total) {
                    message = '¡Felicidades! Eres un experto en Marte. ¡Estás listo para el viaje! 🥳';
                    selectors.finalScore.classList.replace('text-green-400', 'text-yellow-400');
                } else if (score >= total * 0.7) {
                    message = 'Buen trabajo. Estás bien preparado, solo necesitas repasar algunos detalles clave. 👍';
                    selectors.finalScore.classList.replace('text-yellow-400', 'text-green-400');
                } else {
                    message = 'Necesitas repasar la Base de Conocimiento. ¡Revisa los artículos en la pestaña Aprende! 🧐';
            ...
            // Iniciar la simulación del monitor inmediatamente
            simularDatosModulo();
